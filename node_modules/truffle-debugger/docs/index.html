...
<head>
  ...
  <title data-ice="title">Home | truffle-debugger</title>
...
<div class="content" data-ice="content"><div data-ice="index" class="github-markdown"><h1 id="truffle-debugger">truffle-debugger</h1><p>Portable Solidity debugger library, for use with or without Truffle.</p>
<p><img src="https://i.imgur.com/0j5m4KW.gif" alt="Debugger in Action"></p>
<p>Features:</p>
<ul>
<li>Solidity stepping and breakpoints</li>
<li>Variable inspection</li>
<li>Watch expressions</li>
<li>and more!</li>
</ul>
<h2 id="api-documentation">API Documentation</h2><p>API Documentation for this library can be found at <a href="https://trufflesuite.github.io/truffle-debugger/">trufflesuite.github.io/truffle-debugger</a>.</p>
<h2 id="library-usage">Library Usage</h2><p><em>:warning: This documentation is currently a work in progress.
Please see the <a href="https://github.com/trufflesuite/truffle/blob/develop/packages/truffle-core/lib/commands/debug.js">reference integration</a> provided by the <code>truffle debug</code> command.</em></p>
<h3 id="required-parameters">Required Parameters</h3><p>To start a truffle-debugger session, you&apos;ll need the following:</p>
<ul>
<li><code>txHash</code> - A transaction hash (prefixed with <code>0x</code>), for the transaction to debug</li>
<li><code>provider</code> - A web3 provider instance (see <a href="https://github.com/ethereum/web3.js/">web3.js</a>)</li>
<li><code>contracts</code> -  An array of contract objects, with the following properties:<ul>
<li><code>contractName</code> - The name of the contract</li>
<li><code>source</code> - The full Solidity source code</li>
<li><code>sourcePath</code> - (optional) the path to the Solidity file on disk</li>
<li><code>ast</code> - The Solidity compiler&apos;s output AST (new style, not <code>legacyAST</code>)</li>
<li><code>binary</code> - <code>0x</code>-prefixed string with the binary used to create a contract instance</li>
<li><code>sourceMap</code> - The Solidity compiler output source map for the creation binary</li>
<li><code>deployedBinary</code> - <code>0x</code>-prefixed string with the on-chain binary for a contract instance</li>
<li><code>deployedSourceMap</code> - The source map corresponding to the on-chain binary (from the Solidity compiler)</li>
</ul>
</li>
</ul>
<p>Optionally (and recommended), you can also provide a <code>files</code> argument:</p>
<ul>
<li><code>files</code> - An array of sourcePaths representing file indexes (from <code>solc</code> or <code>truffle-compile</code>)</li>
</ul>
<h3 id="invocation">Invocation</h3><ol>
<li>Start the debugger session by constructing a Debugger instance with <code>.forTx()</code> and then <code>.connect()</code> to it:</li>
</ol>
<pre><code class="lang-javascript"><code class="source-code prettyprint">import Debugger from &quot;truffle-debugger&quot;;

let bugger = await Debugger
  .forTx(txHash, { contracts, files, provider });

let session = bugger.connect();</code>
</code></pre>
<ol start="2">
<li>Resolve the session&apos;s <code>ready()</code> promise:</li>
</ol>
<pre><code class="lang-javascript"><code class="source-code prettyprint">await session.ready();</code>
</code></pre>
<ol start="3">
<li>Use the provided public methods on the <code>session</code> instance in order to step through the trace for the transaction:</li>
</ol>
<pre><code class="lang-javascript"><code class="source-code prettyprint">session.stepNext();
session.stepOver();
session.stepInto();</code>
</code></pre>
<ol start="4">
<li>Access data provided by the debugger via the <code>session.view()</code> interface, and the provided selectors:</li>
</ol>
<pre><code class="lang-javascript"><code class="source-code prettyprint">let { ast, data, evm, solidity, trace } = Debugger.selectors;

let variables = session.view(data.current.identifiers.native);
let sourceRange = session.view(solidity.current.sourceRange);</code>
</code></pre>
<h3 id="useful-api-docs-references">Useful API Docs References</h3><ul>
<li><a href="https://trufflesuite.github.io/truffle-debugger/class/lib/session/index.js~Session.html"><strong><code>Session</code> class docs</strong></a></li>
<li><strong>Docs for selectors:</strong><ul>
<li><a href="https://trufflesuite.github.io/truffle-debugger/identifiers.html#ast-selectors"><strong><code>ast</code> selectors</strong></a></li>
<li><a href="https://trufflesuite.github.io/truffle-debugger/identifiers.html#data-selectors"><strong><code>data</code> selectors</strong></a></li>
<li><a href="https://trufflesuite.github.io/truffle-debugger/identifiers.html#evm-selectors"><strong><code>evm</code> selectors</strong></a></li>
<li><a href="https://trufflesuite.github.io/truffle-debugger/identifiers.html#solidity-selectors"><strong><code>solidity</code> selectors</strong></a></li>
<li><a href="https://trufflesuite.github.io/truffle-debugger/identifiers.html#trace-selectors"><strong><code>trace</code> selectors</strong></a></li>
</ul>
</li>
</ul>
<h2 id="contributing">Contributing</h2><p>It&apos;s our goal that this library should serve as a reliable and well-maintained tool for the Solidity ecosystem. Ultimately, we hope to support all language features and meet the varied requirements of a mature debugging library.</p>
<p>We believe that a good Solidity debugger belongs to the community. We welcome, with our most humble gratitude, any and all community efforts in bringing this debugger closer to that goal. If you find something broken or missing, please open an issue!</p>
<p>Some other ideas for how to get involved:</p>
<ul>
<li>Bug fix PRs</li>
<li>Documentation improvements</li>
<li>Additional tests - unit tests and integration</li>
<li>Technical discussion (ways to improve architecture, etc.)</li>
</ul>
<p>Thank you for all the continued support. :bow:</p>
</div>
</div>
