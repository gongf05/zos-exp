...
<head>
  ...
  <title data-ice="title">lib/store/index.js | truffle-debugger</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">lib/store/index.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">if (process.env.NODE_ENV == &quot;production&quot;) {
